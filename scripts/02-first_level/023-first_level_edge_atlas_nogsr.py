...
for task_id in ["stroop", "msit", "rest"]:
    ...
    edge_imgs_dir = opj(project_dir, "results/edge_imgs_nogsr/shen", "task-%s" % task_id)
    ...
    output_dir = opj(project_dir, "results/first-level/edge_nogsr/shen", "task-%s" % task_id)
