...
for task_id in ["stroop", "msit"]:
    ...
    for contrast in contrasts:
        ...
        first_level_dir = opj(project_dir, "results/supplementary/edge_basis_denoise/shen/first-level", "task-%s" % task_id)
        ...
        # Save this
        output_dir = opj(project_dir, "results/supplementary/edge_basis_denoise/shen/second-level/task-%s" % task_id, contrast)
