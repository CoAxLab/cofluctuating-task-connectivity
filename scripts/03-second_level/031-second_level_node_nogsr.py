...
for task_id in ["stroop", "msit"]:
    ...
    for contrast in contrasts:
        ...
        first_level_dir = opj(project_dir, "results/first-level/node_nogsr", "task-%s" % task_id)
        ...
        # Save this
        output_dir = opj(project_dir, "results/second-level/node_nogsr/task-%s" % task_id, contrast)
